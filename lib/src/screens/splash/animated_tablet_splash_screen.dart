...
class AnimatedTabletSplash extends HookWidget {
  const AnimatedTabletSplash({super.key});

  @override
  Widget build(BuildContext context) {
    AnimationController animationController =
        useAnimationController(duration: const Duration(seconds: 2), initialValue: 0);
    animationController.forward();
    AnimationController animationScaleController =
        useAnimationController(duration: const Duration(seconds: 1), initialValue: 0);
    ...
    Animation<double> circleOffsetAnimation = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
      parent: animationScaleController,
    ...
    final slideAnimation1 = Tween<Offset>(begin: const Offset(0, -1), end: const Offset(0, 0)).animate(animation1);
    final slideAnimation2 = Tween<Offset>(begin: const Offset(-1, 0), end: const Offset(0, 0)).animate(animation2);
    final slideAnimation3 = Tween<Offset>(begin: const Offset(1, 0), end: const Offset(0, 0)).animate(animation3);
    final slideAnimation4 = Tween<Offset>(begin: const Offset(0, 1), end: const Offset(0, 0)).animate(animation4);
...
class MyCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(32.5.w, 43.5.h), animationValue * 13.5.h, paint..color = const Color(0xFF642C9B));
